...
def dataset_createdataset():
    ...
    # TODO: Validate with form.validate():
    if request.method == 'POST':
        ...
        new_dataset = {'name': name, 'parent_dataset': path,
                       'metadata': metadata, 'feature_collections': []}
...
def dataset_editdataset():
    ...
    # Render the page
    return render_template('editdataset.html', createdatasetform=form,
                           dataset=dataset)
...
def dataset_deletedataset():
    """Remove a dataset."""
    ds.deletedataset(request.args.get('dataset_id'))
    return redirect(url_for('dataset_view'))
...
@app.route('/featurecollections/createfeaturecollection',
           methods=['GET', 'POST'])
def featurecollections_createfeaturecollection():
    ...
    return render_template('createfeaturecollection.html',
                           createfeaturecollectionform=form)


@app.route('/featurecollections/deletefeaturecollection')
def featurecollections_deletefeaturecollection():
    """Remove a feature collection."""
